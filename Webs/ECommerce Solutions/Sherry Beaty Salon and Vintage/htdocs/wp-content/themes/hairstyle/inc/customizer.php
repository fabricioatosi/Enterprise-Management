...
function hairstyle_customize_preview_js() {
	wp_enqueue_script( 'hairstyle-customize-preview', get_template_directory_uri() . '/js/customize-preview.js', array( 'customize-preview' ), '20141216', true );
}
add_action( 'customize_preview_init', 'hairstyle_customize_preview_js' );