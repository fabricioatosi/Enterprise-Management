 ...
 function gradiant_get_icon_menu_default() {
	return apply_filters(
		'gradiant_get_icon_menu_default', json_encode(
				 array(
				array(
					'title'           => esc_html__( 'Commercial', 'gradiant' ),
					'icon_value'       => 'fa-building',
					'id'              => 'customizer_repeater_hdr_icon_menu_001',
				),
				array(
					'title'           => esc_html__( 'Residential', 'gradiant' ),
					'icon_value'       => 'fa-home',
	...
	return apply_filters(
		'gradiant_get_client_default', json_encode(
				...
				array(
					...
					'title'           => esc_html__( 'Creative', 'gradiant' ),
					'subtitle'           => esc_html__( 'Business', 'gradiant' ),
					'link'       => '#',
	...
	return apply_filters(
		'gradiant_get_features_default', json_encode(
				...
				array(
					...
					'title'           => esc_html__( 'SEO Marketing', 'gradiant' ),
					'text'           => esc_html__( 'Lorem ipsum is simple dummy', 'gradiant' ),
					'link'       => '#',
					'id'              => 'customizer_repeater_features_001',
				),
				array(
					'icon_value'           => 'fa-paint-brush',	
					'title'           => esc_html__( 'Web Design', 'gradiant' ),
					'text'           => esc_html__( 'Lorem ipsum is simple dummy', 'gradiant' ),
					'link'       => '#',
				...
				array(
					'icon_value'           => 'fa-plug',	
					'title'           => esc_html__( 'Features Addons', 'gradiant' ),
					'text'           => esc_html__( 'Lorem ipsum is simple dummy', 'gradiant' ),
					'link'       => '#',
				...
				array(
					...
					'title'           => esc_html__( 'Cloud Host', 'gradiant' ),
					'text'           => esc_html__( 'Lorem ipsum is simple dummy', 'gradiant' ),
					'link'       => '#',
