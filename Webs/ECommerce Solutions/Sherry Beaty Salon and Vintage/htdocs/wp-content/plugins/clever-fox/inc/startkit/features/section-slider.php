		...
		class Startkit_slider__section_upgrade extends WP_Customize_Control {
			...
			?>
				...
				<?php }elseif( 'StartWeb' == $theme->name){ ?>
					<a class="customizer_slider_upgrade_section up-to-pro" href="https://www.nayrathemes.com/startweb-pro/" target="_blank" style="display: none;"><?php _e('Upgrade to Pro','clever-fox'); ?></a>
